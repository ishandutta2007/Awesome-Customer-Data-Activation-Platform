...
- **[Hightouch](https://hightouch.com/)**  
  ...
  Leading warehouse-native reverse ETL and composable CDP platform that syncs modeled audiences and traits from your data warehouse to 250+ business tools.



- **[Census (Fivetran Activations)](https://www.census.dev/)**  

  Reverse ETL and data activation platform (now part of Fivetran) focused on syncing warehouse data into operational systems with strong governance features.



- **[RudderStack](https://www.rudderstack.com/)**  

  Warehouse-first customer data platform offering event streaming, identity resolution, and reverse ETL, with a strong open-source core.



- **[Simon Data](https://www.simondata.com/)**  

  Customer data and marketing activation platform that unifies data and powers personalized campaigns and journeys.



- **[mParticle](https://www.mparticle.com/)**  

  Customer data platform focused on real-time event collection, identity, and activation across marketing and product tools.



- **[Segment (Twilio Segment)](https://segment.com/)**  

  Widely adopted CDP for event collection, identity resolution (Personas), and routing data to hundreds of destinations, including reverse ETL capabilities.



- **[Treasure Data](https://www.treasuredata.com/)**  

  Enterprise customer data platform emphasizing large-scale data unification, governance, and activation for complex organizations.



- **[ActionIQ](https://www.actioniq.com/)**  

  Enterprise composable CDP focused on governed audience building, activation, and analytics for regulated and large-scale marketers.



- **[Zeotap](https://zeotap.com/)**  

  Customer data and identity platform that helps brands unify and activate first-party data across channels.



- **[Optimove](https://www.optimove.com/)**  

  Customer-led marketing and retention platform that combines data unification with campaign orchestration and optimization.
